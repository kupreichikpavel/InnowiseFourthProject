...
public class CompleteOrderCommand implements Command {
    ...
    public String execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            ...
            if (completed) {
                request.setAttribute(ORDER_MESSAGE_ATTRIBUTE, "Order was completed");
            } else {
                request.setAttribute(ORDER_MESSAGE_ATTRIBUTE, "Order was not completed");
            }
            ...
            try {
                ...
                throw new CommandException("Complete order command failed", serviceException);
            }
        }
    }
}